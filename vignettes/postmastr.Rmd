...
Once those dictionaries are built, we can parse the data. The `input` argument is used to define how the address data are structured, and `output` is used to specify what type of output you recieve. 
